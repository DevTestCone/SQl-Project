...
VALUES…
INSERT INTO `offices`(`office_id`, `office_name`, `office_address`, `office_city`, `office_state`, `vat_number`, `registration_number`, `phone`, `free_user_phone`, `email`, `manager_id`, `manager_start_date`)
VALUES…
UPDATE offices SET manager_id =… WHERE office_id =…CREATE DATABASE company
